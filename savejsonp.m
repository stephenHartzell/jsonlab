function json=savejsonp(rootname,obj,varargin)
%
% json=savejsonp(rootname,obj,filename)
%    or
% json=savejsonp(rootname,obj,opt)
% json=savejsonp(rootname,obj,'param1',value1,'param2',value2,...)
%
% convert a MATLAB object (cell, struct or array) into a JSONP (JavaScript
